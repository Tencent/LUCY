...
# MODEL_NAME_OR_PATH="/mnt/data/hetinggao/vita-e2e/outputs/vita_qwen2_s2v2_zh/checkpoint-12400"
...
CODEC_OUT_EXT=(snac snac snac)
DATA_JSONS="$CV2TTS_DIR/train.json $CV2TTS_DIR/train.json $UNION180W_DIR/train.json $FUNCALL_DIR/train.json $FUNCALL_DIR/train.json"
EVAL_DATA_JSONS="$CV2TTS_DIR/eval.json $CV2TTS_DIR/eval.json $UNION180W_DIR/eval.json $FUNCALL_DIR/eval.json $FUNCALL_DIR/eval.json"
TASKS="ASRA AQAA TQAA RQACONVA RQACONV RQACONV RQACONVA RQACONV"
