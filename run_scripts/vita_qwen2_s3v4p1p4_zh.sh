...
MODEL_NAME_OR_PATH="/mnt/data/hetinggao/Projects/vita-e2e/outputs/vita_qwen2_s3v4p1p3_zh2/checkpoint-30000"
...
TASKS="ASRE RQACONVA_NTRL RQACONV_NTRL RQACONVA RQACONV RQACONVA RQACONV RQACONV RQACONV_EMO RQACONVA_EMO RQACONV_EMO RQACONVA_EMO"
#DATA_JSONS="$EMO2_DIR/train.json"
#EVAL_DATA_JSONS="$EMO2_DIR/eval.json"
#TASKS="RQACONVA_EMO"
# TASKS=ASRE
...
# deepspeed --include localhost:0 vita/scripts/train_v4p1.py \
deepspeed --include localhost:0,1,2,3,4,5,6,7 vita/scripts/train_v4p1.py \
