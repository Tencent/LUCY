...
MODEL_NAME_OR_PATH="/mnt/data/hetinggao/Projects/vita-e2e/outputs/vita_qwen2_s3v2p2_zh/checkpoint-34500"
...
COMMON_DIR="/mnt/data/hetinggao/manifest/vita2tts/jsons/common"
FC_DIR="/mnt/data/hetinggao/manifest/vita2tts/jsons/fc"
NATURAL_DIR="/mnt/data/hetinggao/manifest/vita2tts/jsons/natural"
...
DATA_JSONS="$NATURAL_DIR/train.json $NATURAL_DIR/train.json $FC_DIR/train.json $FC_DIR/train.json $COMMON_DIR/train.json $COMMON_DIR/train.json $UNION60W_DIR/train.json"
EVAL_DATA_JSONS="$NATURAL_DIR/eval.json $NATURAL_DIR/eval.json $FC_DIR/eval.json $FC_DIR/eval.json $COMMON_DIR/eval.json $COMMON_DIR/eval.json $UNION60W_DIR/eval.json"
NEGATIVE_TSVS="$NEGA_DIR/all.tsv"
NEGATIVE_RATIO=0.25
TASKS="RQACONVA_NTRL RQACONV_NTRL RQACONVA RQACONV RQACONVA RQACONV RQACONV"
...
# deepspeed --include localhost:0 vita/scripts/train_v5.py \
deepspeed --include localhost:0,1,2,3,4,5,6,7 vita/scripts/train_v5.py \
