...
MANIFEST_DIR=/mnt/data/hetinggao/manifest/custom_questions
OUTPUT_PATH=/mnt/data/hetinggao/vita-e2e/generated/zh_tte_s3_72k_eval_3600tk_custom_aqaa_tf
# TASKS="AQAA"
TASKS="TQAA"

CKPT_PATH=/mnt/data/hetinggao/vita-e2e/outputs/vita_qwen2_s3_zh_parallel_tte-100124-134115/checkpoint-72000
CKPT_PAHT=/mnt/data/hetinggao/vita-e2e/outputs/vita_qwen2_s3_zh-100724-165903/checkpoint-28000
...
python vita/scripts/infer_tf.py \
    --audio_in ${AUDIO_IN} \
    --text_in ${TEXT_IN} \
    --text_out ${TEXT_OUT} \
    --codec_out ${CODEC_OUT} \
