...
MODEL_NAME_OR_PATH="/mnt/data/hetinggao/Projects/vita-e2e/outputs/vita_qwen2-7b-instruct_s3v4p2_zh/checkpoint-26800"
...
deepspeed --include localhost:0,1,2,3,4,5,6,7 vita/scripts/train_v5p2.py \
