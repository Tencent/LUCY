...
WENETEM_DIR="/mnt/data/hetinggao/manifest/SER/stage1"
...
EMO1_DIR="/mnt/data/hetinggao/manifest/Emotion_Control/jsons/instruction"
EMO2_DIR="/mnt/data/hetinggao/manifest/Emotion_Control/jsons/dialog"
...
TEXT_OUT_EXT=(wrd)
CODEC_OUT_EXT=("<NONE>")
DATA_JSONS="$EMO1_DIR/train.jsonl $EMO2_DIR/train.jsonl $UNION60W_DIR/train.json"
EVAL_DATA_JSONS="$EMO1_DIR/eval.jsonl $EMO2_DIR/eval.jsonl $UNION60W_DIR/eval.json"
TASKS="ASRE RQACONV RQACONV RQACONV"
