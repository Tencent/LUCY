...
MODEL_NAME_OR_PATH=/mnt/data/hetinggao/vita-e2e/outputs/vita_qwen2_s2p2_zh_tts_chat
...
DATA_JSONS="$CV2TTS_DIR/train.json $CV2TTS_DIR/train.json $UNION180W_DIR/train.json"
DATA_CODECS="$CV2TTS_DIR/train.snacdict $CV2TTS_DIR/train.snacdict <NONE>"
EVAL_DATA_JSONS="$CV2TTS_DIR/eval.json $CV2TTS_DIR/eval.json $UNION180W_DIR/eval.json"
EVAL_DATA_CODECS="$CV2TTS_DIR/eval.snacdict $CV2TTS_DIR/eval.snacdict <NONE>"
TASKS="ASRA TQAA AQAA"
