...
MODEL_NAME_OR_PATH="/mnt/data/hetinggao/Projects/vita-e2e/outputs/vita_qwen2_s2v3p2_zh"
...
DATA_JSONS="$UNION60W_DIR/train.json $SERS2_DIR/train1.json $SERS2_DIR/train2.json"
EVAL_DATA_JSONS="$UNION60W_DIR/eval.json $SERS2_DIR/eval1.json $SERS2_DIR/eval2.json"
TASKS="AQAA TQAA RQACONV RQACONV_EMO RQACONV_EMO"
