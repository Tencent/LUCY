...
# OUTPUT_DIR=/mnt/data/hetinggao/vita-e2e/outputs/vita_qwen2_s2_zh_tts-101324-161515
# OUTPUT_DIR=/mnt/data/hetinggao/vita-e2e/outputs/vita_qwen2_s2_zh_tts-101924-051635
CACHE_DIR=/mnt/data/hetinggao/models
# MODEL_NAME_OR_PATH="/mnt/data/hetinggao/vita-e2e/outputs/vita_qwen2_s1_zh_tts-101124-133535/checkpoint-80000"
MODEL_NAME_OR_PATH="/mnt/data/hetinggao/vita-e2e/backups/vita_qwen2_s1_zh_tts-101024-034258/checkpoint-40000"
...
DATASET_DIRS=(${WENET_DIR} ${ALPACA_DIR} ${ALPACA_DIR} ${MOSS002_DIR} ${MOSS002_DIR})
AUDIO_IN_EXT=(tsv tsv tsv tsv tsv)
TEXT_IN_EXT=(wrd textin textin textin textin)
TEXT_OUT_EXT=(wrd textout textout textout textout)
CODEC_OUT_EXT=("<NONE>" "<NONE>" "<NONE>" "<NONE>" "<NONE>")
TASKS="ASR TQA AQA TQA AQA"
