...
MODEL_NAME_OR_PATH="/mnt/data/hetinggao/Projects/vita-e2e/outputs/vita_qwen2_s1v3_zh"
...
TEXT_OUT_EXT=(wrd)
CODEC_OUT_EXT=("<NONE>")
DATA_JSONS="/mnt/data/hetinggao/manifest/SER/stage2/train.json"
EVAL_DATA_JSONS="/mnt/data/hetinggao/manifest/SER/stage2/eval.json"
TASKS="RQACONV"
