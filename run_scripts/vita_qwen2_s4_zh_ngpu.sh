...
OUTPUT_DIR=/mnt/data/hetinggao/vita-e2e/outputs/vita_qwen2_s4_zh_ngpu-110224-090936
...
#CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6 python vita/scripts/train_v2.py \
#deepspeed --include localhost:0 vita/scripts/train_v2.py \
#	--deepspeed config/zero2.json\
#CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node 2 --master-port=29501 vita/scripts/train_v2.py \
#deepspeed --include localhost:0,1,2,3 --master_port 60000 vita/scripts/train_v2.py \
#	--deepspeed config/zero2.json\
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 torchrun --nproc_per_node 8 --master-port=29501 vita/scripts/train_v2.py \
    --model_type "qwen2" \
