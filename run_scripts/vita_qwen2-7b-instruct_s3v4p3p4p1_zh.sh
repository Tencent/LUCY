...
MODEL_NAME_OR_PATH="/mnt/data/hetinggao/Projects/vita-e2e/outputs/vita_qwen2-7b-instruct_s2v4p1_zh/checkpoint-28000"
...
FC1_DIR="/mnt/data/hetinggao/manifest/vita2tts_v3/jsons_v2/fcneg241206"
FC2_DIR="/mnt/data/hetinggao/manifest/vita2tts_v3/jsons_v2/fcneg241218"
FC3_DIR="/mnt/data/hetinggao/manifest/vita2tts_v3/jsons_v2/fc_241212"
FC4_DIR="/mnt/data/hetinggao/manifest/vita2tts_v3/jsons_v2/fc_241218"
...
DATA_JSONS="$NATURAL_DIR/train.json $FC_DIR/train.json $FC1_DIR/train.json $FC2_DIR/train.json $FC3_DIR/train.json $FC4_DIR/train.json $COMMON_DIR/train.json $UNION60W_DIR/train.json $EMO1_DIR/train.json $EMO2_DIR/train.json"
EVAL_DATA_JSONS="$NATURAL_DIR/eval.json $FC_DIR/eval.json $FC1_DIR/eval.json $FC2_DIR/eval.json $FC3_DIR/eval.json $FC4_DIR/eval.json $COMMON_DIR/eval.json $UNION60W_DIR/eval.json $EMO1_DIR/eval.json $EMO2_DIR/eval.json"
TASKS="RQACONVA_NTRL RQACONVA RQACONVA RQACONVA RQACONVA RQACONVA RQACONVA RQACONV RQACONVA_EMO RQACONVA_EMO"
