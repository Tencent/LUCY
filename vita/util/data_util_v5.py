...
class TA2TADataset(Dataset):
    def __init__(
        ...
        self.tasks_with_audio_output = set(["AQAA", "TQAA", "TTS", "ASRA", "RQACONVA", "RQACONVA_NTRL"])
        self.tasks_with_random_input = set(["RQACONV", "RQACONVA", "RQACONV_NTRL", "RQACONVA_NTRL"])
    ...
    def tokenize_conversation(self, conversations, task, system_prompt=None) -> Dict:
        ...
        for i, sentence in enumerate(conversations):
            ...
            # print(role, use_audio_input_curr, use_audio_input_prev, contains_only_wav)
