...
import torch
import transformers
import vita.util.data_util_v4p2 as data_util
from typing import Optional, List
from dataclasses import dataclass, field
from transformers import AutoTokenizer, AddedToken
from vita.util import set_random_seed, rank0_print
# from vita.util import data_util_v4p2 as data_util
...
def train():
    ...
    print("tunable paramters:", [n for n, p in model.named_parameters() if p.requires_grad])
